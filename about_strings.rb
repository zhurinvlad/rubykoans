...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # В Ruby, все ссылки. Если F = S, теперь F и S два названия одного и того же объекта.
    # Так << изменяет исходную строку, а не создает новую.
    # В случае +=, ссылаемся на новый объект.
  end
