...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Передаем в inject чему будет равняться начальный параметр,
    # затем, после операции получаем новое значение и 
    # уже оно запоминается для следующей итерации.
  end
  ...
  # Возможно нам не стоит закрывать работу с файлом, 
  # т.к. он сам закроется в 1-м случае, в отличие от 2-го , достигнув конца файла
  # потому как работа с фалом будет происходить в теле блока, а не в теле основного кода. 
